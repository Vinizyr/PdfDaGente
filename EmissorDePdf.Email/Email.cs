...
namespace EmissorDePdf.Email
{
    public class Email
    {
        ...
        public void SendEmail(List<string> emailTo, string assunto, string body, List<string> attachments)
        {
            var message = PrepareteMessage(emailTo, assunto, body, attachments);

            SendEmailBySmtp(message);
        }

        private MailMessage PrepareteMessage(List<string> emailTo, string assunto, string body, List<string> attachments)
        {
